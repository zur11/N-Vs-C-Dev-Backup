...
const _LABEL_TEXTURE_PATH : String = "res://screens/main_menu/assets/settings_1.png"
const _SELECTED_LABEL_TEXTURE_PATH : String = "res://screens/main_menu/assets/settings_2.png"
